...
<div class="card">
    ...
    <div class="card-body">
        <form name="add-category" id="add-blog-post-form" method="post" action="{{route('pricing.store')}}">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1">Package Name</label>
                <input type="text" class="form-control" name="package_name" value="" placeholder="Enter Package Name">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="premium_job" value="" placeholder="Enter Premium Job">
